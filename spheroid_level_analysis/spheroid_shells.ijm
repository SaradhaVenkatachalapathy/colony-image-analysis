...
for(i=0; i<filenames1.length; i++){
		...
		a=370000/(width*height*depth);// obtain the number of pixels in a  volume of 1,000,000 cu.microns or  maximum value
		a_1=100000/(width*height*depth);// obtain the number of pixels in a  volume of 5,000 cu.microns or  minimum value
