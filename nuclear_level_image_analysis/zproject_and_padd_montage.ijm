...
run("Scale Bar...", "width=15 font=14 color=White background=None location=[Lower Right] bold hide label"); // add scale bar of 50 microns
run("Make Montage...", "scale=1 border=3"); // Make a montage
saveAs("Jpeg", newDirm + "Montage_nuclei_DNA"); // save the image of the montage

/////// CHANNEL 2

dir=dirsa + "indivisual_nuclei"+ch2_name+ File.separator;
filename = getFileList(dir); // get the list of files
...
run("Scale Bar...", "width=15 font=14 color=White background=None location=[Lower Right] bold hide label"); // add scale bar of 50 microns
run("Make Montage...", "scale=1 border=3"); // Make a montage
saveAs("Jpeg", newDirm + "Montage_nuclei_"+ch2_name); // save the image of the montage

}

/////// CHANNEL 3

dir=dirsa + "indivisual_nuclei"+ch3_name+ File.separator;
filename = getFileList(dir); // get the list of files
...
run("Scale Bar...", "width=15 font=14 color=White background=None location=[Lower Right] bold hide label"); // add scale bar of 50 microns
run("Make Montage...", "scale=1 border=3"); // Make a montage
saveAs("Jpeg", newDirm + "Montage_nuclei_"+ch3_name); // save the image of the montage

}
/////// CHANNEL 4

dir=dirsa + "indivisual_nuclei"+ch4_name+ File.separator;
filename = getFileList(dir); // get the list of files
...
run("Scale Bar...", "width=15 font=14 color=White background=None location=[Lower Right] bold hide label"); // add scale bar of 50 microns
run("Make Montage...", "scale=1 border=3"); // Make a montage
saveAs("Jpeg", newDirm + "Montage_nuclei_"+ch4_name); // save the image of the montage
